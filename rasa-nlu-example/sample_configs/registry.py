...
from rasa_nlu_gao.extractors.hanlp_extractor import HanlpExtractor  # customize
...
component_classes = [
    ...
    MitieTokenizer, SpacyTokenizer, WhitespaceTokenizer, JiebaTokenizer, HanlpTokenizer,
